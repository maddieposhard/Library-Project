    ...
    },
    {
        ...
        ownedBooks: [
            ...
            },
            {
                ...
                description: "The book examines the reasons behind the lack of progress on ambitious projects in the United States, including those related to affordable housing, infrastructure, and climate change.",
                image: 'https://m.media-amazon.com/images/I/71dn+hvNIOL._AC_UF1000,1000_QL80_.jpg',
                isbn: 1668023482
            },
            {
                title: 'Lethal Prey',
            ...
            },
            {
                ...
                description: "The book follows two sisters, Vianne and Isabelle, as they navigate life during World War II in German-occupied France. Vianne, the older sister, lives in Carriveau with her husband and daughter, while Isabelle, the younger sister, is more rebellious and eventually joins the French resistance..",
            ...
            },
            {
                ...
                description: "Set over a single day at a summer retreat on Cape Cod, the story unfolds as Elle Bishop must choose between the life she built with her husband and the passionate past she shares with her childhood love.",
              ...
              },
              {
                ...
                description: "In 1950s Mexico, glamorous socialite Noemí Taboada is summoned to a remote mansion where her cousin believes she's being poisoned. What she finds is a terrifying house full of secrets and something far more sinister beneath the surface.",
              ...
              },
              {
                ...
                author: 'Alka Joshi',
                genre: ['Historical', 'Fiction'],
                description: "In 1950s Jaipur, Lakshmi escapes an abusive marriage and becomes the most sought-after henna artist to the rich. Her carefully constructed life is disrupted when her estranged husband appears with a sister she never knew she had.",
                image: 'https://m.media-amazon.com/images/I/81D40vFCMzS._AC_UF1000,1000_QL80_.jpg',
                isbn: 9780778331476
              },
              {
                ...
                genre: ['Historical', 'Fiction'],
                description: "Based on the true story of the American Library in Paris during WWII, this novel follows Odile, a librarian who joins the resistance. Decades later, her story is uncovered by a lonely teenager in Montana, connecting them in unexpected ways.",
    ...
    },
    {
        ...
        ownedBooks: [
            ...
            },
            {
                ...
                author: 'Delia Owens',
                genre: ['Mystery', 'Fiction'],
                description: "Set in the marshes of North Carolina, the story follows Kya Clark, the 'Marsh Girl', who grows up in isolation. When a local man is found dead, suspicion falls on her as the secrets of her past begin to unravel.",
                image: 'https://m.media-amazon.com/images/I/81SjX1vUR4L._UF1000,1000_QL80_.jpg',
                isbn: 9780735219106
              },
              {
                title: 'Circe',
                ...
                description: "A reimagining of the story of Circe, daughter of the sun god Helios, who is banished to a deserted island. There, she hones her powers and crosses paths with some of the most famous figures in Greek mythology.",
              ...
              },
              {
                ...
                description: "Tara Westover recounts her journey from growing up in a survivalist family in rural Idaho—with no formal education—to earning a PhD from Cambridge University. A story of resilience, self-discovery, and the transformative power of learning.",
              ...
              },
              {
                ...
                description: "Between life and death, there's a library where every book represents a different life you could have lived. Nora Seed finds herself in this library and explores the infinite choices that could've changed her story.",
              ...
              },
              {
                ...
                description: "Ryland Grace wakes up alone on a spaceship with no memory and a mission to save humanity. As his memory returns, he realizes the scale of the task—and the alien alliance he must form to succeed.",
